...
public class LoginUserService{
    ...
    public TokenDTO tokenGenerator(String userId) {
        ...
        return TokenDTO.builder()
                .accessToken("Bearer" + tokenProvider.createAcessToken(userDto.getUserId(), Collections.singletonList(userDto.getUserRole())))
                .refreshToken("Bearer" + tokenProvider.createRefreshToken(userDto.getUserId(), Collections.singletonList(userDto.getUserRole())))
                .build();
    }
